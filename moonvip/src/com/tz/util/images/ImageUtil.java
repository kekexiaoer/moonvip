...
public class ImageUtil {
	...
	public static boolean cutImage(Image srcImage, String destImg, int left,
		...
		// 目标图片
		ImageFilter cropFilter = new CropImageFilter(left, top, 150, 102);
		Image cutImage = Toolkit.getDefaultToolkit().createImage(
				new FilteredImageSource(srcImage.getSource(), cropFilter));
		// 重绘图片
		BufferedImage tag = new BufferedImage(150, 102,
				BufferedImage.TYPE_INT_RGB);
		Graphics g = tag.getGraphics();
		g.drawImage(
				cutImage.getScaledInstance(150, 102, Image.SCALE_SMOOTH),
				0, 0, null); // 绘制缩小后的图
		g.dispose();
		// 输出为文件
		...
		ImageUtil
				.cutImage(
						ImageIO.read(new File(
								"C:\\Users\\Administrator\\Desktop\\新建文件夹\\5333fd630001b1bb06000338-590-330.jpg")),
						"C:\\Users\\Administrator\\Desktop\\jy\\small0111.jpg", 15, 20, 110, 150);
	}
}
