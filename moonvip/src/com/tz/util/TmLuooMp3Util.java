...
//		}
		...
		for (int i = 739; i > 734; i--) {
				java.io.File file = new java.io.File("f://mp3/"+i);
				...
				for (int j = 1; j <= count; j++) {
					try{
						String text = j+"";
						if(j<10)text = "0"+j;
						TmDownLoadImageUtil.download("http://luoo.waasaa.com/low/luoo/radio"+i+"/"+text+".mp3", "f://mp3/"+i+"/"+text+".mp3");
					}catch(Exception ex){
						continue;
					}
				}
