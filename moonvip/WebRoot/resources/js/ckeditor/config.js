...
//		{ name: 'clipboard',   groups: [ 'clipboard' ] },
	...
	//config.extraPlugins = 'UploadPic,UploadCode,UploadMovie,UploadFile,UpLink';//UploadCode,insertcode
	config.extraPlugins = 'UploadPic,UploadCode,UploadFile';//UploadCode,insertcode,UploadFile
