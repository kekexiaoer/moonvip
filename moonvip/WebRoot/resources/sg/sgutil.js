...
$(function(){
	...
	if(v=="ie_6" || v=="ie_7"){
		$("body").append("<div id='tipnobox' style='background:#1F53A0;padding:240px 0;text-align:center;font-size:36px;font-weight:700;color:#fff;position:fixed;width:100%;height:100%;top:0;left:0;z-index:9999'>很是遗憾，作者关闭了IE6,7,8。为推动互联的发展做贡献....</div>");
